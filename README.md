# 🤖 ChatGPT Lookalike: Streamlit + Anthropic API  

Welcome to **ChatGPT Lookalike**, a lightweight and interactive chatbot application built with **Streamlit** and powered by the **Anthropic API**. This project is a basic yet powerful conversational AI tool that allows users to ask any kind of query and get human-like responses in real-time.  

---

## 🚀 Features  
- **Real-time Chat**: Ask questions and get instant responses.  
- **Powered by Anthropic**: Leverages advanced AI for accurate and engaging answers.  
...
- **Anthropic API**: For natural language processing and response generation.  
...
![Welcome text](welcome.png)

![Chat text](chat.png)

![Translate text](translate.png)

![Converse text](converse.png)
...
- **Anthropic API** for powering the chatbot's intelligence.  
